...
def add_to_watchlist(user_id, film_id, public=True):
    ...
    Args:
        ...
        public (bool): Whether the entry is visible to other users.
            Defaults to True (see the visibility-default decision in
            pr-response.md, Comment 4). Callers may pass False to add a
            film privately.
...
def get_watchlist(user_id):
    ...
    (newest first) to match get_collection (see Comment 5).
